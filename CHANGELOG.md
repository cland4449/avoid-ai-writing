...
- Validate CLI `--unit` argument in `scripts/fp-measure.js` before starting measurement, exiting with code 2 on missing or unrecognized values (`paragraph` and `document` accepted).
